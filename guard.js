...
const costUsage = new Map();
const checkRateLimitInternal = (key, limit, windowSeconds) => {
    const now = Date.now();
...
export const guard = {
     ...
     */
    checkRateLimit: (actionType, userId = 'anonymous') => {
        // Configuration
     ...
     * Tracks usage.
     */
    checkCost: (actionType, userId = 'anonymous', estimatedCost = 1) => {
