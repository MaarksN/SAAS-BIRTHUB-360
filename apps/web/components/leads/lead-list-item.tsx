      ...
      <div className="hidden grid-cols-4 items-center gap-4 border-b border-slate-700 p-4 transition-colors hover:bg-slate-800/50 md:grid">
        ...
        <div>
           <span className={`rounded-full px-2.5 py-0.5 text-xs font-medium ${
             lead.status === 'NEW' ? 'border border-blue-800 bg-blue-900/50 text-blue-200' :
             lead.status === 'QUALIFIED' ? 'border border-emerald-800 bg-emerald-900/50 text-emerald-200' :
        ...
        <div className="text-right">
          <button className="text-sm font-medium text-indigo-400 hover:text-indigo-300">View Details</button>
        </div>
      </div>
