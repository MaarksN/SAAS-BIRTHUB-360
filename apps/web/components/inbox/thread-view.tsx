  ...
  return (
    <div className="flex h-full flex-1 flex-col bg-slate-950">
      <div className="flex items-center justify-between border-b border-slate-700 bg-slate-900/50 p-4">
        <h2 className="text-lg font-bold text-slate-100">Project Proposal (Mock Subject)</h2>
        <div className="flex gap-2">
            <Button variant="secondary" className="h-8 text-xs">Archive</Button>
            <Button variant="secondary" className="h-8 text-xs">Delete</Button>
        </div>
      </div>
      ...
      <div className="flex-1 space-y-6 overflow-y-auto p-6">
        ...
        <div className="mt-8 border-t border-slate-800 pt-6">
            ...
            <div className="mt-2 flex justify-end">
                <Button className="bg-indigo-600 text-white hover:bg-indigo-500">Send Reply</Button>
            </div>
        </div>
      </div>
    </div>
