    ...
    <div className="space-y-8">
      ...
      <Card className="border-none bg-slate-900 p-8 text-center text-white">
        ...
        <p className="mx-auto mb-8 max-w-xl text-slate-400">
          Get real-time estimates for TAM, SAM, and SOM based on aggregated
          market data.
        </p>
        <form onSubmit={handleAnalyze} className="mx-auto flex max-w-md gap-2">
          ...
          <Button
            type="submit"
            className="h-12 bg-blue-600 px-8 text-lg hover:bg-blue-500"
            disabled={loading}
          >
        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 items-end justify-center gap-8 pt-8 md:grid-cols-3">
          ...
          <div className="group flex flex-col items-center">
            <div className="mb-4 text-center">
              ...
              <h3 className="text-3xl font-extrabold text-slate-700 dark:text-slate-200">
                {formatCurrency(data.tam.value)}
              </h3>
              <p className="text-xs text-slate-500">
                {data.tam.companies.toLocaleString()} Companies
              </p>
            </div>
            <div
              className="relative w-full overflow-hidden rounded-t-xl bg-blue-100 transition-all duration-1000 group-hover:bg-blue-200 dark:bg-blue-900/30 dark:group-hover:bg-blue-900/50"
              style={{ height: '300px' }}
            >
          ...
          <div className="group flex flex-col items-center">
            <div className="mb-4 text-center">
              ...
              <h3 className="text-3xl font-extrabold text-slate-700 dark:text-slate-200">
                {formatCurrency(data.sam.value)}
              </h3>
              <p className="text-xs text-slate-500">
                {data.sam.companies.toLocaleString()} Companies
              </p>
            </div>
            <div
              className="relative w-full overflow-hidden rounded-t-xl bg-indigo-100 transition-all duration-1000 group-hover:bg-indigo-200 dark:bg-indigo-900/30 dark:group-hover:bg-indigo-900/50"
              style={{ height: '200px' }}
            >
          ...
          <div className="group flex flex-col items-center">
            <div className="mb-4 text-center">
              ...
              <h3 className="text-3xl font-extrabold text-slate-700 dark:text-slate-200">
                {formatCurrency(data.som.value)}
              </h3>
              <p className="text-xs text-slate-500">
                {data.som.companies.toLocaleString()} Companies
              </p>
            </div>
            <div
              className="relative w-full overflow-hidden rounded-t-xl bg-emerald-100 transition-all duration-1000 group-hover:bg-emerald-200 dark:bg-emerald-900/30 dark:group-hover:bg-emerald-900/50"
              style={{ height: '100px' }}
            >
          ...
          <Card className="border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">
                The market is showing strong signs of consolidation. SAM is
                restricted by regulatory compliance in the fintech sector, but
                SOM is highly achievable given your current product fit.
              </p>
            </CardContent>
          </Card>
        </div>
