      ...
      <div className="flex h-full flex-col">
        ...
        <div className="flex flex-1 flex-col px-6">
            ...
            <div className="mb-4 mt-auto rounded-lg border border-slate-100 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-800/50">
                <div className="flex items-start gap-2">
                    <span className="mt-0.5 shrink-0 text-xs font-bold uppercase text-slate-500">Pain:</span>
                    <span className="line-clamp-2 text-xs italic text-slate-700 dark:text-slate-300">"{tool.pain}"</span>
                </div>
            </div>
        </div>
        ...
        <div className="mt-auto p-6 pt-2">
            {tool.status === 'planned' ? (
                ...
                <Link href={`/market-intelligence/tool/${tool.id}`} className="block w-full">
                    <Button
                        variant="primary"
