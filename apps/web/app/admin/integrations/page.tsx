  ...
  return (
    <div className="container mx-auto p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card className="bg-slate-900 border-slate-700">
            <CardHeader>
                <div className="flex justify-between items-start">
                    ...
                    {hubspotConnected ? (
                        <Badge className="bg-emerald-900 text-emerald-200 border-emerald-800">Connected</Badge>
                    ) : (
            ...
            <CardContent>
                ...
                {hubspotConnected ? (
                    ...
                    <a href="/api/integrations/hubspot/install">
                        <Button className="w-full bg-[#ff7a59] hover:bg-[#ff8f73] text-white">
                            Connect HubSpot
                        </Button>
                    </a>
                )}
        ...
        <Card className="bg-slate-900 border-slate-700 opacity-75">
            <CardHeader>
