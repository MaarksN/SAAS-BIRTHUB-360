      ...
      <div className="mb-10 text-center md:text-left">
        ...
        <p className="max-w-3xl text-lg leading-relaxed text-slate-600 dark:text-slate-400">
          ...
          <span className="font-semibold text-blue-600">
            robust, intelligent, and complete tools
          </span>{' '}
          designed to solve your specific market intelligence challenges. From
          defining your ICP to generating strategic reports, accelerate your
          workflow here.
        </p>
      </div>
