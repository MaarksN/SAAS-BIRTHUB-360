  ...
  if (!tool) {
    return (
      <div className="p-8 text-center">
        ...
        <Link href="/market-intelligence" className="mt-4 inline-block text-blue-600 hover:underline">
          Return to Dashboard
        </Link>
      </div>
    );
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50 dark:bg-slate-950">
      ...
      <div className="flex items-center gap-2 border-b border-slate-200 bg-white px-6 py-4 text-sm dark:border-slate-800 dark:bg-slate-900">
        <Link href="/market-intelligence" className="flex items-center gap-1 text-slate-500 hover:text-slate-800 dark:hover:text-slate-300">
