      ...
      <div className="flex min-h-screen items-center justify-center bg-slate-950 text-slate-100">
        <Card className="border-red-800 bg-red-900/10">
          <CardContent className="p-6">
            ...
            <p className="mt-2 text-slate-400">Please ask the administrator to send a new invitation.</p>
          </CardContent>
        </Card>
      </div>
    );
      ...
      <Card className="w-full max-w-md border-slate-700 bg-slate-900">
        ...
        <CardContent className="space-y-4">
          ...
          <form action={handleAccept} className="space-y-4">
            <div>
                <label className="mb-1 block text-sm font-medium text-slate-300">Set Password</label>
