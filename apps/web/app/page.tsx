...
import { BarChart, Check, ChevronRight, Target, Users,Zap } from "lucide-react";
      ...
      <main>
        ...
        <section className="mx-auto max-w-5xl px-4 pb-12 pt-24 text-center md:pb-24 md:pt-32">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <Link href="/dashboard">
              <Button variant="primary" className="h-12 w-full px-8 text-lg sm:w-auto">
                Start Free Trial <ChevronRight className="ml-2 size-5" />
              </Button>
            </Link>
            <Link href="#demo">
              <Button variant="outline" className="h-12 w-full px-8 text-lg sm:w-auto">
                Watch Demo
              </Button>
            </Link>
          </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 py-16 dark:border-slate-800 dark:bg-slate-950">
          <div className="mx-auto max-w-7xl px-4 text-center">
            <p className="mb-8 text-sm font-semibold uppercase tracking-wider text-slate-500">Trusted by forward-thinking teams</p>
        ...
        <section className="bg-blue-600 py-24 text-center text-white">
          <div className="mx-auto max-w-4xl px-4">
            <h2 className="mb-6 text-3xl font-bold md:text-4xl">Ready to transform your sales process?</h2>
            <p className="mb-8 text-lg text-blue-100">Join thousands of sales professionals crushing their quotas with SalesOS.</p>
            <Link href="/dashboard">
